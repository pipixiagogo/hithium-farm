...
public class PropertiesConfig {
    ...
    public boolean verifyProvinceOfCity(String province,String city){
        if (!org.apache.commons.lang.StringUtils.isEmpty(province) && !org.apache.commons.lang.StringUtils.isEmpty(city)) {
            Set<String> provinces = getProToCitys().get(province);
            if (CollectionUtils.isEmpty(provinces) && provinces.isEmpty()) {
                return false;
            }
        ...
        if(org.apache.commons.lang.StringUtils.isEmpty(province) && !org.apache.commons.lang.StringUtils.isEmpty(city)){
            String prov = getCitys().get(city);
            if(org.apache.commons.lang.StringUtils.isEmpty(prov)){
                return false;
            }
        }
        return true;
