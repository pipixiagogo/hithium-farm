...
public class DeviceController extends AbstractController {
    ...
    public ResHelper<BuguPageQuery.Page<DeviceVo>> queryDevicesByPage(@RequestParam(value = "page", required = false) Integer page,
    ...
    public ResHelper<BuguPageQuery.Page<DeviceInfoVo>> queryDeviceWithoutBindByPage(@RequestParam(value = "page", required = false) Integer page,
                                                                                    @RequestParam(value = "pageSize", required = false) Integer pageSize,
                                                                                    @RequestParam(value = "deviceName", required = false) String deviceName) {
        if (page == null || pageSize == null) {
            return ResHelper.pamIll();
    ...
    public ResHelper<BuguPageQuery.Page<DeviceInfoVo>> deviceAreaList(@RequestParam(value = "page", required = false) Integer page,
                                                                      @RequestParam(value = "pageSize", required = false) Integer pageSize,
